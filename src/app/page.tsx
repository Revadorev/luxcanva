...
const content = {
  en: {
    ...
    heroSubtitle:
      "LuxCanva is a Romania-based canvas production workshop offering premium canvas printing, large-format wall art, white-label fulfillment and print-on-demand services for ecommerce brands, interior designers, photographers and resellers across Europe.",
    ctaPrimary: "Request B2B Pricing",
    ctaSecondary: "Order Samples",
    trustBadges: ["Made in EU", "White-Label Fulfillment", "Large Format Printing", "Fast Production", "Custom Sizes"],
    ...
    services: [
      ...
      ["Large Format Canvas Printing", "We can produce oversized canvas prints and panoramic formats, ideal for premium wall art collections."],
    ...
    capabilities: [
      ...
      "Canvas with varnish / relief effect, depending on project requirements",
    ],
    ...
    b2b: [
      ...
      "Easy expansion into new canvas sizes",
  ...
  ro: {
    ...
    heroSubtitle:
      "LuxCanva este un atelier de producție canvas din România care oferă print premium pe canvas, wall art de mari dimensiuni, fulfillment white-label și servicii print-on-demand pentru branduri ecommerce, designeri de interior, fotografi și reselleri din Europa.",
    ctaPrimary: "Solicită prețuri B2B",
    ctaSecondary: "Comandă mostre",
    trustBadges: ["Produs în UE", "Fulfillment White-Label", "Print Large Format", "Producție Rapidă", "Dimensiuni Custom"],
    ...
    services: [
      ...
      ["Print Canvas Large Format", "Putem produce canvas-uri oversized și formate panoramice, ideale pentru colecții premium de wall art."],
    ...
    why: [
      ...
      "Ideal pentru branduri care vor să reducă costurile și timpii de livrare în Europa",
    ],
    ...
    capabilities: [
      ...
      "Canvas cu efect de lac / relief, în funcție de proiect",
    ],
    ...
    b2b: [
      ...
      "Extindere ușoară către noi dimensiuni canvas",
